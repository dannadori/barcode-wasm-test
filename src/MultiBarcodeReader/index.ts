...
export class MultiBarcodeReader{
    ...
    requestScanBarcode = (captureCanvas:HTMLCanvasElement, col_num:number, row_num:number, split_margin:number) =>{
        this.scalableSS.predict(captureCanvas, col_num, row_num, split_margin)
